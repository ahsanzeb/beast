...
Ignore the coupling between the $e_{g}$ and $t_{2g}$ manifolds (between $xy$ and $x^2-y^2$ at $\alpha=0$,
...
and $E_{ex}$ becomes the lower than $E_{yz/zx}$, by about $6\%$ of $\Delta_o$ at $15^\circ$.
...
whereas in the net effect of both cages
...
We also see that $E_0^{t_{2g}}$ shows slight negative shift to a slight positive shift
when as $q_A/q_o$ increases when going from Fig.~\ref{fig:t2g-alpha0}(a)
...
\right),
\end{align}
where the matrix elements have relatively long expressions and can be found in the appendix. An approximation at small $\alpha,\beta$ is given later in this section. 
...
In contrast to $\alpha=0$ case discussed in previous section,
...
The splittings are also abut the same magnitude, between $4$-$6\%$ at $\alpha=15^\circ$
