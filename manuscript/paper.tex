...
KosterRMP12,
%Structure, physical properties, and applications of ${\mathrm{SrRuO}}_{3}$ thin films},

%electronic correlations:
~\cite{DagottoS05,DagottoMRSB08}
...
WangPRX16,
% {Stabilization of Highly Polar ${\mathrm{BiFeO}}_{3}$-like Structure: A New Interface Design Route for Enhanced Ferroelectricity in Artificial Perovskite Superlattices}
CavigliaPRL12,
%{Ultrafast Strain Engineering in Complex Oxide Heterostructures},
XiaPRB09,
%{Critical thickness for itinerant ferromagnetism in ultrathin films of ${\text{SrRuO}}_{3}$},
...
LeePRL10,
%{Epitaxial-Strain-Induced Multiferroicity in ${\mathrm{SrMnO}}_{3}$ from First Principles},
WangPRL15,
%{Observation of Magnetoelectric Multiferroicity in a Cubic Perovskite System: ${\mathrm{LaMn}}_{3}{\mathrm{Cr}}_{4}{\mathrm{O}}_{12}$},
...
KidaPRB08,
%{Electrically driven spin excitation in the ferroelectric magnet ${\text{DyMnO}}_{3}$},
ChoPRL16,
...
ShirakoPRB11,
%{Integer spin-chain antiferromagnetism of the 4$d$ oxide CaRuO${}_{3}$ with post-perovskite structure},
DikinPRL11,
% {Coexistence of Superconductivity and Ferromagnetism in Two Dimensions},
ChoudhuryPRL12,
%{Near-Room-Temperature Colossal Magnetodielectricity and Multiglass Properties in Partially Disordered ${\mathrm{La}}_{2}{\mathrm{NiMnO}}_{6}$},

LeePRL11,
%  {Electrolyte Gate-Controlled Kondo Effect in ${\mathrm{SrTiO}}_{3}$},
...
HalcrowRSC13,
PavariniChap}
whereby the orbital degeneracy of the B ions
is lifted that stabilises the distortion---
}
...
and explore the octahedral rotations from the perspective
of (first order) JT effect itself
}
...
The Jahn--Teller effect~\cite{JahnPRSL37,JahnPRSL38,OpikRS57,Sturge68,GehringRPP75,KugelSPU82,PavariniChap} describes the 
...
V^{B}_{4,0}&= \frac{4\sqrt{\pi } }{3} \left(\frac{24 \sec ^5\beta }{(\cos 2 \alpha +3)^{5/2}}+\sec ^5\alpha \right),\\
 V^{B}_{4,4}&=  - \frac{16 \sqrt{35 \pi } }{3} \frac{(-20 \cos 2 \alpha +\cos 4 \alpha -13) %\sec ^5\beta }
 }
