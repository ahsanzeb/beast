...
% orbital ordering
We have focused on the B ion at $(0,0,0)$ but 
there are three more B ions in the unit cell 
at finite octahedral rotations.
We find that the splittings in the spectra
of all B ions are
practically identical.
However, their eigenstates 
are different in a way that 
creates interesting orbital ordering
which depends on the tilt and rotation angles,
...
Of course, beside the crystal field we considered in our simplistic model,
in real materials,
...
the system might encounter charge instabilities similar to the structural ones (i.e., JT),
where the system is stabilised by a charge transfer from one site to another
that lowers the electronic energy and costs 
the ``elastic'' energy proportional the chemical hardness of the ions involved.
