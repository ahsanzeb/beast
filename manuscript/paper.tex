...
para2: rot understood in terms of a tolerance factor... relative sizes of ions...\\
nothing substantial exists in the literature to explore the cause/reasons ... rotations...\\
except only recently, nick paper,... hydrogen bonding etc...
...
that exhibit a rich variety of electronic, magnetic and optical properties
due to the interplay between \az{[refine...]}
orbital, spin, correlations, charge and structure. 

orbital ordering... 
orbital-structure interplay.... structure-property relationships... 
...
Their crystal structures have a common formula unit ABX$_3$,
where 
...
It is a deformation of the crystal field at the transition metal (JT ion) site.
Does the same happen in the case of octahedral tilting and rotations?
While the potential of the octahedral anion cage does not change in case of 
rigid rotations for obvious reason,
the net crystal field 
does change indeed
because the rest of the lattice is not only rotated (that turns its non-spherical potential)
in a given octahedron's frame but also distorted.
So, in principle, there should be a (first order) JT effect at play.
Using this insight
and elements of
crystal field theory,
here in this manuscript
we explore this problem in detail and 
find that the magnitude of this JT effect is sizeable for typical systems.
...
analysis summary\\
results summary\\
We analytical results... numerical results... full lattice...

we explore states and energies of JT ion as a function of rotation and tilting angles...

and find that the
magnitude of the effect depends on the relative 
charges on the two cations involved, A and B,
and is sizeable for typical systems.
...
\com{
What is it that lifts the degeneracy in the classical JT effect?
its a deformation of the crystal field at the transition metal/JT ion site.
Does a deformation happen in the case of octahedral tilting and rotations?
Ridig octahedral.... octaherdal field of the octahedral anions cage is not changed 
... but... AB cages and the rest of the lattice is rotated and deformed... so... of course the CF should deform...
So there are in principle clear signs that there should be a (first order) JT effect at play.
}
...
\az{
Here, we .... just like the classical JT effect, where octahedral potential deforms....
....

we consider Pbnm.... other tilting and rotation.. glazer notation...???
}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.5\linewidth]{/Users/maz/repos/perovskite/calc/analytical-structure-param/full-lattice-potential-tests/full-lattice-vs-AB}
