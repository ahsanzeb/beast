...
As long as the two competing terms have different dependence on the distortion,
...
$E_0^{t_{2g}}$, $E_0^{e_{g}}$ and $\Delta$ are rescaled by a factor of ${1-5\delta/3}$.
...
we should have $D_{2} > 100/27 D_{4}, 25/9 D_{4}$
and hence it's $D_{2}$ term that determines the sign and size of the splittings in 
Eqs.~\ref{eq:JTt2g},\ref{eq:JTeg}.

\subsection{Example, given a ne, see if instability exists:}
...
% leading order expansion in beta:
%A 2,4: \left\{\frac{64 \beta ^2}{63 \sqrt{3}}+O\left(\beta ^3\right),\frac{40960 \beta ^2}{5103 \sqrt{3}}+O\left(\beta ^3\right)\right\}
%B 2,4: \left\{-\frac{3 \beta ^2}{7}+O\left(\beta ^3\right),-\frac{115 \beta ^2}{63}+O\left(\beta ^3\right)\right\}
